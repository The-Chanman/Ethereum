...
if [ $1 == "disturbed" ]; then
  ...
  #statements
  echo "BOX FIXED"
  curl -X POST --data '{"jsonrpc":"2.0","method":"eth_sendTransaction","params":[{"from": "0x0171d54c207ccf841352f3ea6c1f07750ee8cdec","to": "0xf73e48ec5261942464421fa2a66a17e3ae86bcde",  "gas": "0x70fc", "data":"0xd19eaac6"}],"id":8}' http://localhost:8545
